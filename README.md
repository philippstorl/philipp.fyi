...
| `e2e/work.spec.ts`                    | All 4 case study pages render, card links resolve correctly, homepage cards stay lazy-loaded, og:type is article with article:published_time, share-image alt text is the case study title; Work index page heading/cards, no skipped heading levels between the h1 and the card titles, eager/priority loading on the featured + first non-featured covers, interlinks to About/Principles/Recommendations                                                                                                                                                                                                                                                                                                               |
...
| `e2e/favicons.spec.ts`                | `rel="apple-touch-icon"` link, `/apple-touch-icon.png` served as a 180×180 PNG, `/favicon.ico` served as a real ICO (not the 404 page)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
