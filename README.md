...
| `e2e/work.spec.ts`                    | All 4 case study pages render, card links resolve correctly, homepage cards stay lazy-loaded, og:type is article with article:published_time; Work index page heading/cards, no skipped heading levels between the h1 and the card h3s, eager/priority loading on the featured + first non-featured covers, interlinks to About/Principles/Recommendations              |
