...
| `e2e/work.spec.ts`            | All 4 case study pages render, card links resolve correctly, homepage cards stay lazy-loaded, og:type is article with article:published_time; Work index page heading/cards, eager/priority loading on the featured + first non-featured covers, interlinks to About/Principles/Recommendations                                                                         |
