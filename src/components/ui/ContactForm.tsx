...
export default function ContactForm() {
    ...
    const inputBase =
        'w-full rounded-lg border border-border-strong bg-background px-4 py-3 text-base text-foreground placeholder:text-muted transition-colors duration-150 focus:border-accent focus:ring-1 focus:ring-accent'
