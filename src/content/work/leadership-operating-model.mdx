...
description: "Three years leading a web development team: the processes, career track, and standards that let a distributed team scale and deliver predictably."
category: "Leadership"
tags: ["Team Leadership", "Career Track", "Processes", "GitHub", "Remote"]
year: "2022–2024"
order: 3
draft: false
coverImage: "./leadership-operating-model/leadership-vancouver-cover.jpg"
---
...
import img2021 from "./leadership-operating-model/leadership-2021-office.jpg"
import img2022 from "./leadership-operating-model/leadership-2022-working.jpg"
import img2023 from "./leadership-operating-model/leadership-2023-staffbase.jpg"
import img2024 from "./leadership-operating-model/leadership-2024-coworking.jpg"

In October 2021, I stepped into the Lead Web Developer role, and it became clear that I was on track to lead the team formally, which happened in January 2022, when I became Team Lead Web Development. Before that, I'd been the only web developer at Staffbase for nearly two years, from March 2018 until my first hire joined in January 2020, doing the work of a team by myself, and had been leading informally ever since. Building the actual team, and building the structures that would let it function, was a different kind of challenge.
...
<ResponsiveFigure
    src={img2021}
    alt="An empty open-plan office with exposed ceiling ducts, white columns, rows of desks with monitors, and yellow tape marking walkways on the floor"
    caption="November 2021, first trip - the Bananatag Vancouver office, week one of the onboarding."
    {...fullWidthFigureSizing()}
    class="my-8"
/>
...
<div class="my-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
    <div class="flex flex-col gap-4">
        <ResponsiveFigure
            src={img2022}
            alt="Three people around a meeting-room table with laptops, drinks, and snacks, a wall-mounted screen showing a document behind them"
            caption="June 2022, second trip - a working session in Vancouver."
            {...responsiveGridFigureSizing(TWO_COLUMN_RESPONSIVE_TIERS)}
        />
        <ResponsiveFigure
            src={img2023}
            alt="Two people sitting behind rows of desk monitors, one flashing a peace sign, the other a thumbs-up, with a large green Staffbase logo on the wall behind them"
            caption="June 2023, fourth trip - at the Staffbase Vancouver desk."
            {...responsiveGridFigureSizing(TWO_COLUMN_RESPONSIVE_TIERS)}
        />
    </div>
    <ResponsiveFigure
        src={img2024}
        alt="A laptop on a table in the foreground, with people working by floor-to-ceiling windows that look out on water, white sail-shaped rooftops, and mountains"
        caption="November 2024, sixth and final trip - a coworking space overlooking the harbor, German keyboard a long way from home."
        {...responsiveGridFigureSizing(TWO_COLUMN_RESPONSIVE_TIERS)}
    />
</div>
...
One thing I was deliberate about: staying a developer, and not because the leadership responsibilities left room to spare. A team lead who can't contribute technically is a bottleneck, not a resource, however demanding the leadership side of the role gets. I kept writing code, reviewing pull requests with depth, and owning technical decisions. When the Storyblok migration began after I'd transitioned back to IC, I brought that same hands-on instinct to the project: contributing directly to implementation and bridging SensioLabs' Symfony expertise with our actual content and workflows, rather than stepping back into a purely advisory role.
