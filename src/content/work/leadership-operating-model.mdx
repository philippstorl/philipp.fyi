...
<div class="my-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
    <div class="flex flex-col gap-4">
        ...
        <ResponsiveFigure
            src={img2023}
            alt="Two people sitting behind rows of desk monitors, one flashing a peace sign, under a large green Staffbase logo on the wall"
    ...
    <ResponsiveFigure
        src={img2024}
        alt="A laptop on a worktable in the foreground, with people working at long tables in front of floor-to-ceiling windows that look out on water, white sail-shaped rooftops, and mountains"
