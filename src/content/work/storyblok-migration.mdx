...
<div class="my-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
    <ResponsiveFigure
        src={imgJp}
        alt="staffbase.com homepage in Japanese: hero headline with a product screenshot"
    ...
    <ResponsiveFigure
        src={imgDe}
        alt="staffbase.com homepage in German: 'Für alle Mitarbeitenden' hero with a product screenshot"
...
<div class="my-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
    <ResponsiveFigure
        src={imgFr}
        alt="staffbase.com homepage in French: 'La seule plateforme qui atteint vraiment chaque collaborateur' hero with an email newsletter mockup and a row of customer logos"
        caption="French locale: added post-launch as a configuration change, not a rebuild."
        {...responsiveGridFigureSizing(TWO_COLUMN_RESPONSIVE_TIERS)}
    />
    <ResponsiveFigure
        src={imgEs}
        alt="staffbase.com homepage in Spanish: 'Creada para todos' hero with a product screenshot"
