...
<div class="my-8 grid grid-cols-2 gap-4">
    <figure>
        ...
        <figcaption class="mt-2 text-sm text-muted">
            {
                "Japanese locale at launch — the most immediately legible proof of a working multilingual architecture."
            }
        </figcaption>
    </figure>
    <figure>
        ...
        <figcaption class="mt-2 text-sm text-muted">
            {
                "German locale — Staffbase's home market, live on the new stack on the same day."
            }
        </figcaption>
    </figure>
</div>
...
<figure class="my-8">
    <Image
        ...
        width={430}
        class="mx-auto rounded-xl border border-border"
    />
    <figcaption class="mt-2 text-sm text-muted">
        {
            "The navigation rebuild: sticky header, backdrop blur, and mobile overlay with body-scroll lock — a full structural overhaul shipped to a hard external deadline."
        }
    </figcaption>
</figure>
...
<div class="my-8 grid grid-cols-2 gap-4">
    <figure>
        ...
        <figcaption class="mt-2 text-sm text-muted">
            {
                "French locale — added post-launch as a configuration change, not a rebuild."
            }
        </figcaption>
    </figure>
    <figure>
        ...
        <figcaption class="mt-2 text-sm text-muted">
            {
                "Spanish, added the same way. Two new markets without a single architectural change."
            }
        </figcaption>
    </figure>
</div>
