...
<div class="my-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
  <figure>
    <Image src={voices2020} alt="VOICES website homepage in 2020, the original Eleventy build" />
    <figcaption class="text-sm text-muted mt-2">2020 — the original Eleventy build</figcaption>
  </figure>
  <figure>
...
<p class="text-sm text-muted italic">Screenshots span April 2020 to June 2026 — earlier years via Wayback Machine archives, the 2026 regional and component shots captured live from the production site. Live-captured pages reflect that specific date; event dates, lineups, and registration status have moved on since.</p>
