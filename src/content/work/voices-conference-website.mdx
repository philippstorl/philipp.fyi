...
<div class="my-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
    <ResponsiveFigure
        ...
        {...responsiveGridFigureSizing(voices2020PreEleventy, [
    ...
    <ResponsiveFigure
        ...
        {...responsiveGridFigureSizing(voices2020, [
            { minWidth: 640, columns: 2 },
            { columns: 1 },
        ])}
    />
...
<div class="my-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <ResponsiveFigure
        ...
        {...responsiveGridFigureSizing(voices2022, [
            { minWidth: 1024, columns: 3 },
            { minWidth: 640, columns: 2 },
            { columns: 1 },
        ])}
    ...
    <ResponsiveFigure
        ...
        caption="2023"
        {...responsiveGridFigureSizing(voices2023, [
            { minWidth: 1024, columns: 3 },
            { minWidth: 640, columns: 2 },
            { columns: 1 },
        ])}
    ...
    <ResponsiveFigure
        ...
        caption="2024"
        {...responsiveGridFigureSizing(voices2024, [
            { minWidth: 1024, columns: 3 },
            { minWidth: 640, columns: 2 },
            { columns: 1 },
        ])}
    ...
    <ResponsiveFigure
        ...
        {...responsiveGridFigureSizing(voices2025, [
            { minWidth: 1024, columns: 3 },
            { minWidth: 640, columns: 2 },
            { columns: 1 },
        ])}
    ...
    <ResponsiveFigure
        ...
        {...responsiveGridFigureSizing(voices2026, [
            { minWidth: 1024, columns: 3 },
            { minWidth: 640, columns: 2 },
            { columns: 1 },
        ])}
...
<div class="my-6 flex flex-col justify-center gap-4 sm:flex-row">
    <ResponsiveFigure
        ...
        {...fixedWidthFigureSizing(voices2026DeMobile, 320)}
        class="max-w-xs"
        captionClass="mt-2 text-center text-sm text-muted"
    />
    <ResponsiveFigure
        src={voices2026DeMobileNav}
        alt="VOICES Berlin mobile navigation menu open, 2026"
        caption="Mobile - navigation"
        {...fixedWidthFigureSizing(voices2026DeMobileNav, 320)}
        class="max-w-xs"
        captionClass="mt-2 text-center text-sm text-muted"
    />
</div>
...
<div class="my-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
    <ResponsiveFigure
        ...
        {...responsiveGridFigureSizing(voices2026De, [
    ...
    <ResponsiveFigure
        ...
        {...responsiveGridFigureSizing(voices2026En, [
            { minWidth: 640, columns: 3 },
            { columns: 1 },
        ])}
    />
    <ResponsiveFigure
        ...
        {...responsiveGridFigureSizing(voices2026Emea, [
            { minWidth: 640, columns: 3 },
            { columns: 1 },
        ])}
    />
...
<ResponsiveFigure
    ...
    {...fullWidthFigureSizing(voices2026Overview)}
    class="my-6"
/>
...
<ResponsiveFigure
    ...
    {...fullWidthFigureSizing(voices2026Agenda)}
    class="my-6"
/>
...
<ResponsiveFigure
    ...
    {...fullWidthFigureSizing(voices2026Recordings)}
    class="my-6"
/>
