...
description: "Six years evolving the VOICES conference website: introducing Eleventy, scaling to multi-region, and staying consistent through two rebrands."
...
<div class="my-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    <ResponsiveFigure
        src={voices2020}
        alt="VOICES website homepage in August 2020, the first Eleventy build, counting down to the October 2020 event"
        caption="After - August 2020, the first Eleventy build, ahead of the October event"
        {...responsiveGridFigureSizing(TWO_COLUMN_RESPONSIVE_TIERS)}
    />
</div>
...
<div class="my-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
    <ResponsiveFigure
        ...
        {...responsiveGridFigureSizing(REGIONAL_RESPONSIVE_TIERS)}
    />
    <ResponsiveFigure
        src={voices2026En}
