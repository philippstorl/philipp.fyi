...
order: 4
draft: false
coverImage: "./voices-2026.png"
---

import { Image } from 'astro:assets';
import voices2020 from './voices-2020.png';
import voices2020PreEleventy from './voices-2020-pre-eleventy.png';
import voices2022 from './voices-2022.png';
import voices2023 from './voices-2023.png';
import voices2024 from './voices-2024.png';
import voices2025 from './voices-2025.png';
import voices2026 from './voices-2026.png';
import voices2026De from './voices-2026-de.png';
import voices2026En from './voices-2026-en.png';
import voices2026Emea from './voices-2026-emea.png';
import voices2026Overview from './voices-2026-overview.png';
import voices2026Agenda from './voices-2026-agenda.png';
import voices2026Recordings from './voices-2026-recordings.png';
import voices2026DeMobile from './voices-2026-de-mobile.png';
import voices2026DeMobileNav from './voices-2026-de-mobile-nav.png';
...
<div class="my-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
  <figure>
    <Image src={voices2020PreEleventy} alt="VOICES website homepage in April 2020, the plain-HTML site maintained by an external agency" />
    <figcaption class="text-sm text-muted mt-2">Before — April 2020, plain HTML, agency-maintained</figcaption>
  </figure>
  <figure>
    <Image src={voices2020} alt="VOICES website homepage in October 2020, the first Eleventy build" />
    <figcaption class="text-sm text-muted mt-2">After — October 2020, the first Eleventy build</figcaption>
  </figure>
</div>
...
<div class="my-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
  <figure>
    <Image src={voices2020} alt="VOICES website homepage in 2020" />
    <figcaption class="text-sm text-muted mt-2">2020</figcaption>
  </figure>
  <figure>
    <Image src={voices2022} alt="VOICES website homepage after the 2022 rebrand" />
    <figcaption class="text-sm text-muted mt-2">2022 — first rebrand</figcaption>
  </figure>
  <figure>
    <Image src={voices2023} alt="VOICES website homepage in 2023" />
    <figcaption class="text-sm text-muted mt-2">2023</figcaption>
  </figure>
  <figure>
    <Image src={voices2024} alt="VOICES website homepage in 2024" />
    <figcaption class="text-sm text-muted mt-2">2024</figcaption>
  </figure>
  <figure>
    <Image src={voices2025} alt="VOICES website homepage after the 2025 rebrand" />
    <figcaption class="text-sm text-muted mt-2">2025 — second rebrand</figcaption>
  </figure>
  <figure>
    <Image src={voices2026} alt="VOICES website homepage in 2026, current state" />
    <figcaption class="text-sm text-muted mt-2">2026 — current state</figcaption>
  </figure>
</div>
...
<div class="my-6 flex flex-col sm:flex-row gap-4 justify-center">
  <figure class="max-w-xs">
    <Image src={voices2026DeMobile} alt="VOICES Berlin homepage on mobile, 2026" />
    <figcaption class="text-sm text-muted mt-2 text-center">Mobile — homepage</figcaption>
  </figure>
  <figure class="max-w-xs">
    <Image src={voices2026DeMobileNav} alt="VOICES Berlin mobile navigation menu open, 2026" />
    <figcaption class="text-sm text-muted mt-2 text-center">Mobile — navigation</figcaption>
  </figure>
</div>
...
<p class="text-sm text-muted mb-2">Same component library, three regional configurations — captured side by side in 2026:</p>
<div class="my-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
  <figure>
    <Image src={voices2026De} alt="VOICES Berlin (DE) homepage, 2026" />
    <figcaption class="text-sm text-muted mt-2">Berlin — in-person, German</figcaption>
  </figure>
  <figure>
    <Image src={voices2026En} alt="VOICES Americas (NA) homepage, 2026" />
    <figcaption class="text-sm text-muted mt-2">Americas — virtual</figcaption>
  </figure>
  <figure>
    <Image src={voices2026Emea} alt="VOICES London (EMEA) homepage, 2026" />
    <figcaption class="text-sm text-muted mt-2">London — in-person</figcaption>
  </figure>
</div>
<figure class="my-6">
  <Image src={voices2026Overview} alt="VOICES region picker hub page, listing all four editions" />
  <figcaption class="text-sm text-muted mt-2">The hub page that routes to each regional edition</figcaption>
</figure>
...
<figure class="my-6">
  <Image src={voices2026Agenda} alt="VOICES Americas multi-track agenda page, 2026" />
  <figcaption class="text-sm text-muted mt-2">The multi-track agenda component, populated for VOICES Americas 2026</figcaption>
</figure>
...
<figure class="my-6">
  <Image src={voices2026Recordings} alt="VOICES Americas recordings page, the after-event lifecycle state, 2026" />
  <figcaption class="text-sm text-muted mt-2">The after-event state — recordings populated automatically from YouTube</figcaption>
</figure>
