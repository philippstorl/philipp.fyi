...
I wrote this to our CMO in a longer message about what the web team was actually trying to achieve: _"Our main goal is that we deliver high quality, scalable and sustainable solutions. This helps us remain efficient in our small and high-performing team."_ I meant every word. That instinct eventually became a formal go-live quality gate, so the standard didn't depend on me personally pushing back every time.

That kind of pushback can look like stubbornness from the outside. It's investment, and it pays for itself: building something scalable and maintainable takes more care upfront, but it's what makes a small team actually sustainable over time.
